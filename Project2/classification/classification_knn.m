...
sgtitle('HOG Feature Extraction')
...
tic
[knn_classifier, accuracy] = trainKNN(train_features,train_labels,test_features,test_labels, 'cityblock', 5, 0, 'inverse');
toc
...
%load('segmentation.mat', "selected_images")
...
predicted_labels_knn = predict(knn_classifier, features);
figure(4); 
col = round(num/2);
resized_images = true(128, 128, num);
for n = 1:num
    ...
    title(predicted_labels_knn(n));
end
sgtitle('KNN Predicted Labels');