...
% KernelFunction: "linear", "gaussian", "polynomial"
% boxConstraints = [0.1, 1, 10, 100];
% kernelScales = ['auto', 0.5, 1, 2];
% polynomialOrders = [2, 3, 4, 5];
% when the KernelFunction is "polynomial", use function trainSVM_poly
tic
[svm_classifier, accuracy] = trainSVM(training_features,training_labels,test_features,test_labels, "gaussian", 1, 'auto');
toc
